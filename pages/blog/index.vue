        ...
        <div class="card">
          <div class="row">
            <div class="col-md-5 wrapthumbnail">
              <nuxt-link to="/blog/awesome-nuxt-content">
            ...
            <div class="col-md-7">
              <div class="card-block">
                <h2 class="card-title"><nuxt-link to="/blog/awesome-nuxt-content">We're living some strange times</nuxt-link></h2>
